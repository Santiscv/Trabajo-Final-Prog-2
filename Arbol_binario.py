class ArbolBinarioBusqueda:
    ...
    def __setitem__(self,c,v):     # toma self, clave y valor
        self.agregar(c,v)          #se asigna una clave y un valor
    ...
    def __getitem__(self,clave):
        ...
        if res:          # si la variable "res", que es una clave, tiene asignado un valor:
            return res   # retorna el valor.
        else:
            raise KeyError('Error, la clave no está en el árbol')

    def __contains__(self,clave): # Debe devolver True si el elemento está presente en el objeto y False en caso contrario.
    ...
    def __delitem__(self,clave):   #Modularizacion de la funcion eliminar para llamarla.
        self.eliminar(clave)
